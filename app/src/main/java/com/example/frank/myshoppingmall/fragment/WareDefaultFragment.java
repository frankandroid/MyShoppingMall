 ...
 * 更新描述   ${TODO}
 */
public class WareDefaultFragment extends BaseFragment {
    ...
    public static WareDefaultFragment newInstance(String id) {
        WareDefaultFragment fragment = new WareDefaultFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = View.inflate(mActivity, R.layout.fragment_ware_default, null);
