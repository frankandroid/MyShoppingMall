 ...
 * 更新描述   ${TODO}
 */
public class WareSalesFragment extends BaseFragment {
    ...
    public static WareSalesFragment newInstance(String id) {
        WareSalesFragment fragment = new WareSalesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = View.inflate(mActivity, R.layout.fragment_ware_sales, null);
